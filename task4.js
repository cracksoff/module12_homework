function SomeDevices(name, mode, power) {
	this.name = name
	this.mode = mode
	this.power = power
...
function WashingMachine(name, brand, creatingCountry, power, mode) {
	this.name = name
	this.brand = brand
...
WashingMachine.prototype = new SomeDevices()

function MusicCenter(name, brand, creatingCountry, size, power, mode) {
	this.name = name
	this.brand = brand
	this.creatingCountry = creatingCountry
	this.size = size
...
MusicCenter.prototype = new SomeDevices()

function Computer(name, brand, cost, specification, power, mode) {
	this.name = name
	this.brand = brand
	this.cost = cost
...
Computer.prototype = new SomeDevices()
